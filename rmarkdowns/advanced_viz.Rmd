...
```{r, warning = FALSE}
SP3a4 <- ggplot(data = sdr_data, aes(x= goal_3_score, y = goal_4_score, fill = regions_used_for_the_sdr)) +
  geom_point() +
  theme_minimal() +
  scale_fill_viridis_d(option = "plasma")+
  labs(title = "Scatterplot of SDG Goal Scores 3 & 4",
       x = "SDG 3 Score",
       y = "SDG 4 Score",
       fill = "Regions")
ggplotly(SP3a4)
...
mytext <- paste(
    ...
    "Goal 9 Score: ", round(sdr_data_world_joined$goal_9_score, 2), 
    sep="") %>%
...
leaflet(sdr_data_world_joined) %>% 
  ...
  addPolygons(stroke = FALSE, fillOpacity = 0.5, smoothFactor = 0.5, color = ~colorQuantile("BuPu", goal_9_score)(goal_9_score), label = mytext)
#Challenge Dos
```
